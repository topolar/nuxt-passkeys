          ...
          <div class="flex items-center space-x-4">
            <div class="hidden md:flex md:items-center md:space-x-4">
              <template v-if="!loggedIn">
                <NuxtLink to="/register" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 px-3 py-2 rounded-md text-sm font-medium flex items-center">Register</NuxtLink>
              </template>
              <template v-else>
                <NuxtLink to="/admin" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 px-3 py-2 rounded-md text-sm font-medium flex items-center">Admin</NuxtLink>
                <button @click="logout" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 px-3 py-2 rounded-md text-sm font-medium flex items-center">Logout</button>
              </template>
            </div>
            <button 
              @click="toggleTheme" 
              class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 p-2 rounded-lg transition-colors duration-200 flex items-center justify-center"
            ...
            <a 
              ...
              class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 transition-colors duration-200 p-2 rounded-lg flex items-center justify-center"
